...
\begin{figure}[t]
    \centering
    \fbox{\begin{minipage}[c][4.0cm][c]{0.75\linewidth}
    \centering
    Placeholder diagram for the equidistant-subclass geometry.\par
    (To be replaced by the final schematic figure.)
    \end{minipage}}
    \caption{Placeholder for the geometric layout of classes and equidistant subclasses used in Dataset 1.}
