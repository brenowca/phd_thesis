...
\translatedtitle{Rumo a uma Interpretação Local de Modelos Neurais Baseados em Atenção}
...
\keyword{Modelos baseados em atenção}
\keyword{Grokking}
\keyword{Auto-encoder esparso}
\keyword{Cross-layer transcoders}
\keyword{IA neuro-symbólica}
\keyword{Redes Lógicas de Tensor}
%
% inicio do documento
%
\begin{document}
